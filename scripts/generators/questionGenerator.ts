  ...
  matematik: [
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`{${ans - 2}}`, `{${ans - 1}}`, `{${ans}}`, `{${ans + 1}}`, `{${ans + 2}}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${ans - 54}`, `${ans}`, `${ans + 50}`, `${ans + 100}`, `${ans + 150}`],
          correctIndex: 1,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${ans - 4}`, `${ans - 2}`, `${ans}`, `${ans + 2}`, `${ans + 4}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${ans - 5}`, `${ans - 2}`, `${ans}`, `${ans + 2}`, `${ans + 5}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${base}^${ansExp - 2}`, `${base}^${ansExp - 1}`, `${base}^${ansExp}`, `${base}^${ansExp + 1}`, `${Math.pow(base, ansExp)}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${whole - 50}`, `${whole - 20}`, `${whole}`, `${whole + 20}`, `${whole + 50}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${Ek - 50}`, `${Ek - 25}`, `${Ek}`, `${Ek + 25}`, `${Ek + 50}`],
          correctIndex: 2,
  ...
  kimya: [
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${vol - 22.4}`, `${vol - 11.2}`, `${vol}`, `${vol + 11.2}`, `${vol + 22.4}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`${mols - 1}`, `${mols - 0.5}`, `${mols}`, `${mols + 0.5}`, `${mols + 1}`],
          correctIndex: 2,
    ...
    },
    {
      generate: (idx: number) => {
        ...
        return {
          ...
          options: [`10⁻${pH - 2}`, `10⁻${pH - 1}`, `10⁻${pH}`, `10⁻${pH + 1}`, `10⁻${pH + 2}`],
          correctIndex: 2,
  ...
  biyoloji: [
    {
      generate: (idx: number) => {
        const topics = [
          {
            content: 'Hücre zarının temel yapı birimi aşağıdakilerden hangisidir?',
            options: ['Protein', 'Fosfolipid', 'Karbonhidrat', 'Nükleik asit', 'Vitamin'],
            correctIndex: 1,
            solution: 'Hücre zarı fosfolipid çift tabakasından oluşur. Fosfolipidler amfifilik moleküllerdir ve hücre zarının temel yapı birimidir.',
            subject: 'Hücre Biyolojisi'
          },
          {
            content: 'Fotosentezin ışık bağımlı tepkimeleri hücrenin hangi bölümünde gerçekleşir?',
            options: ['Sitoplazma', 'Mitokondri', 'Tilakoid', 'Stroma', 'Çekirdek'],
            correctIndex: 2,
            solution: 'Fotosentezin ışık bağımlı tepkimeleri kloroplastların tilakoid zarlarında gerçekleşir. Burada ATP ve NADPH üretilir.',
            subject: 'Fotosentez'
          },
          {
            content: 'DNA\'nın replikasyonu hangi enzim tarafından gerçekleştirilir?',
            options: ['RNA polimeraz', 'DNA polimeraz', 'Ligaz', 'Helikaz', 'Primaz'],
            correctIndex: 1,
            solution: 'DNA replikasyonu DNA polimeraz enzimi tarafından gerçekleştirilir. Bu enzim yeni nükleotidleri ekleyerek DNA zincirini sentezler.',
            subject: 'Genetik'
          },
          {
            content: 'Hücre solunumunun ilk aşaması hangisidir?',
            options: ['Glikoliz', 'Krebs döngüsü', 'Elektron taşıma sistemi', 'Fermantasyon', 'Oksidasyon'],
            correctIndex: 0,
            solution: 'Hücre solunumunun ilk aşaması glikolizdir. Sitoplazmada gerçekleşir ve glikoz 2 pirüvata parçalanır.',
            subject: 'Hücre Solunumu'
          },
          {
            content: 'Mitoz bölünmede kromozom sayısı nasıl değişir?',
            options: ['Yarıya iner', 'İki katına çıkar', 'Değişmez', 'Üç katına çıkar', 'Dörtte birine iner'],
            correctIndex: 2,
            solution: 'Mitoz bölünmede kromozom sayısı değişmez. Ana hücre ile oluşan hücreler eşit sayıda kromozoma sahiptir (2n → 2n).',
  ...
  tarih: [
    {
      generate: (idx: number) => {
        const topics = [
          {
            content: 'Osmanlı Devleti\'nin kuruluş yılı aşağıdakilerden hangisidir?',
            options: ['1071', '1299', '1453', '1520', '1923'],
            correctIndex: 1,
            solution: 'Osmanlı Devleti 1299 yılında Osman Bey tarafından kurulmuştur. 1071 Malazgirt Savaşı, 1453 İstanbul\'un Fethi yıllarıdır.',
            subject: 'Osmanlı Tarihi'
          },
          {
            content: 'Türkiye Cumhuriyeti\'nin ilk cumhurbaşkanı kimdir?',
            options: ['İsmet İnönü', 'Mustafa Kemal Atatürk', 'Celal Bayar', 'Cemal Gürsel', 'Cevdet Sunay'],
            correctIndex: 1,
            solution: 'Mustafa Kemal Atatürk, 29 Ekim 1923\'te Türkiye Cumhuriyeti\'nin ilk cumhurbaşkanı olmuştur ve 1938\'e kadar bu görevde kalmıştır.',
            subject: 'Türkiye Cumhuriyeti Tarihi'
          },
          {
            content: 'I. Dünya Savaşı hangi yıllar arasında gerçekleşmiştir?',
            options: ['1912-1913', '1914-1918', '1919-1922', '1939-1945', '1950-1953'],
            correctIndex: 1,
            solution: 'I. Dünya Savaşı 1914-1918 yılları arasında gerçekleşmiştir. 28 Haziran 1914\'te başlamış, 11 Kasım 1918\'de sona ermiştir.',
          ...
          },
          {
            ...
            correctIndex: 2,
            solution: 'İstanbul\'un fethi 29 Mayıs 1453\'te II. Mehmet (Fatih Sultan Mehmet) tarafından gerçekleştirilmiştir.',
            subject: 'Osmanlı Tarihi'
          },
          {
            content: 'Lozan Antlaşması hangi tarihte imzalanmıştır?',
            options: ['30 Ekim 1918', '11 Kasım 1918', '24 Temmuz 1923', '29 Ekim 1923', '1 Kasım 1922'],
            correctIndex: 2,
            solution: 'Lozan Antlaşması 24 Temmuz 1923 tarihinde imzalanmıştır. Bu antlaşma ile Türkiye\'nin bağımsızlığı uluslararası alanda tanınmıştır.',
            subject: 'Türkiye Cumhuriyeti Tarihi'
          }
        ];
        const topic = topics[idx % topics.length];
        ...
        const topics = [
          {
            ...
            options: ['Atlas Okyanusu', 'Pasifik Okyanusu', 'Hint Okyanusu', 'Kuzey Buz Denizi', 'Güney Okyanusu'],
            correctIndex: 1,
            solution: 'Pasifik Okyanusu, yaklaşık 165 milyon km² yüzölçümü ile Dünya\'nın en büyük okyanusudur. Tüm kara parçalarını kapsayabilecek büyüklüktedir.',
            subject: 'Fiziki Coğrafya'
          },
          {
            content: 'Ekvatora en yakın iklim kuşağı hangisidir?',
            options: ['Kutup iklimi', 'Ilıman iklim', 'Ekvatoral iklim', 'Akdeniz iklimi', 'Karasal iklim'],
            correctIndex: 2,
            solution: 'Ekvatora en yakın bölgede ekvatoral iklim görülür. Bu iklim kuşağında yıl boyunca sıcaklık yüksek ve yağış boldur.',
            subject: 'İklim'
          },
          {
            ...
            correctIndex: 1,
            solution: 'Kızılırmak, 1355 km uzunluğu ile Türkiye\'nin en uzun nehridir ve tümüyle Türkiye sınırları içinde akar.',
          ...
          },
          {
            ...
            correctIndex: 1,
            solution: 'Çin, yaklaşık 1.4 milyar nüfusu ile dünyanın en kalabalık ülkesidir. (Not: 2023 itibariyle Hindistan geçmiş olabilir)',
...
async function main() {
  ...
  const config = [
    { subject: 'matematik', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 40 },
    { subject: 'fizik', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 40 },
    { subject: 'kimya', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 40 },
    { subject: 'biyoloji', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 30 },
    { subject: 'tarih', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 20 },
    { subject: 'cografya', years: [2020, 2021, 2022, 2023, 2024, 2025], questionsPerYear: 20 },
  ];
  ...
  for (const item of config) {
    ...
    for (const year of item.years) {
      try {
        ...
        const filename = path.join(outputDir, `tyt-${item.subject}-${year}.json`);
        ...
        console.log(`  ✅ ${year}: ${pkg.questions.length} soru → ${path.basename(filename)}`);
      } catch (error) {
        console.error(`  ❌ ${year}: Hata -`, error instanceof Error ? error.message : error);
      }
    }
  }
